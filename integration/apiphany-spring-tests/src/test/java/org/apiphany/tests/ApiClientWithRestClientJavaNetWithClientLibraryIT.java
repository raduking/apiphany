...
/**
 * Test class for {@link org.apiphany.client.http.SpringRestExchangeClient} with explicit JavaNet client library
 * configuration. Extends the auto-detected JavaNet base class and adds the {@code clientLibrary} property override.
 *
 * @author Radu Sebastian LAZIN
 */
public class ApiClientWithRestClientJavaNetWithClientLibraryIT extends ApiClientWithRestClientJavaNetIT {
