...
import org.apiphany.json.jackson3.Jackson3JsonBuilder;
...
class RedactedValueSerializerTest {
	...
	class SerializeComplexObjectTests {
		...
		void shouldRedactComplexObjectFieldsRecursively() {
			...
			String json = Strings.removeAllWhitespace(Jackson3JsonBuilder.toJson(dto));
		...
		void shouldBeDeserializableAfterRedaction() {
			...
			String json = Jackson3JsonBuilder.toJson(dto);
			WalletDto result = Jackson3JsonBuilder.fromJson(json, WalletDto.class);
