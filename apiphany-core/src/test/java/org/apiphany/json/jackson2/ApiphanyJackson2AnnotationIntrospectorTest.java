...
class ApiphanyJackson2AnnotationIntrospectorTest {
	...
	private ApiphanyJackson2AnnotationIntrospector annotationIntrospector = ApiphanyJackson2AnnotationIntrospector.getInstance();
	...
	void shouldReturnPropertyNameForFieldNameAnnotationOnSerialization() {
		...
		PropertyName propertyName = annotationIntrospector.findNameForSerialization(annotated);
	...
	void shouldReturnPropertyNameForFieldNameAnnotationOnDeserialization() {
		...
		PropertyName propertyName = annotationIntrospector.findNameForDeserialization(annotated);
	...
	void shouldReturnWriteAccessForIgnoredAnnotation() {
		...
		Access access = annotationIntrospector.findPropertyAccess(annotated);
	...
	void shouldReturnFieldOrderForFieldOrderAnnotation() {
		...
		String[] result = annotationIntrospector.findSerializationPropertyOrder(annotatedClass);
	...
	void shouldReturnTrueForAsValueAnnotation() {
		...
		boolean isAsValue = annotationIntrospector.hasAsValue(annotated);
