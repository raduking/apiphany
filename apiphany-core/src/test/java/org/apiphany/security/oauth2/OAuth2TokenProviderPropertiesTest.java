...
class OAuth2TokenProviderPropertiesTest {
	...
	private static final double FAILURE_REFRESH_MULTIPLIER = 2.0d;
	...
	void shouldInitializeWithDefaultPropertiesOnNewInstance() {
		...
		assertThat(properties.getFailureRetryDelayMultiplier(), equalTo(OAuth2TokenProviderProperties.Default.FAILURE_RETRY_DELAY_MULTIPLIER));
	...
	void shouldSetAndGetPropertiesCorrectly() {
		...
		properties.setFailureRetryDelayMultiplier(3.0d);
		...
		assertThat(properties.getFailureRetryDelayMultiplier(), equalTo(3.0d));
	...
	void shouldHaveTheProvidedDefaults() {
		...
		assertThat(OAuth2TokenProviderProperties.Default.FAILURE_RETRY_DELAY_MULTIPLIER, equalTo(FAILURE_REFRESH_MULTIPLIER));
