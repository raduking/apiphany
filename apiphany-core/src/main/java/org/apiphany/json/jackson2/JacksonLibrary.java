 ...
 * <p>
 * This class provides information about the presence of the Jackson JSON library in the classpath and should not have
...
public class JacksonLibrary {
	...
	/**
	 * Pair that shows if Jackson JSON library is present in the classpath and the {@link JsonBuilder} specific class.
	 */
