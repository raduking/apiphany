 ...
 * <p>
 * This enum defines the expected life-cycle of a client instance. It indicates whether the client is ephemeral (short-lived)
 * or long-lived (intended for reuse across multiple operations or sessions).
 *
...
public enum ClientLifecycle {
	 ...
	 * frequently. This is suitable for scenarios where clients are used for single operations or sessions and then discarded.
	 */
	EPHEMERAL,
