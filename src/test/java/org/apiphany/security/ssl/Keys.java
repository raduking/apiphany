...
public class Keys {
	...
	public static KeyPair loadKeyPairFromResources() {
		...
		LOGGER.info("Loaded private key:\n{}", Bytes.hexDumpRaw(X25519Keys.toRawByteArray(privateKey)));
