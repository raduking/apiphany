 ...
 */
public class JacksonJsonContentConverter<T> implements ContentConverter<T> {

	/**
	 * Constructs a new {@link JacksonJsonContentConverter}. This constructor is intentionally empty, as no special
	 * initialization is required.
	 */
	public JacksonJsonContentConverter() {
		// empty
	}
